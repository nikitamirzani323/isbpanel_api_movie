...
const (
	...
	DB_tbl_mst_series_season  string = "tbl_mst_series_season"
	...
	DB_tbl_trx_prediksislot   string = "tbl_trx_gameslot"
	...
	DB_VIEW_MOVIEFAVORITE     string = "VIEW_MOVIEFAVORITE"
	DB_VIEW_MOVIE_GENRE       string = "VIEW_MOVIE_GENRE"
